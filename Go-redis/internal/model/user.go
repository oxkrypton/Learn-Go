...
type User struct {
	...
	NickName   string    `gorm:"column:nick_name;type:varchar(32);default:'';comment:昵称，默认是用户id" json:"nickName"`
...
type UserInfo struct {
	UserID     uint64    `gorm:"primaryKey;column:user_id;comment:主键，用户id" json:"userId"`
